...
import java.util.*
import com.example.ar.LineSimplifier as LineSimplifier1
...
class LineSimplifier {
    ...
    private fun smoothPoints() {
        val pointsToSmooth: List<Vector3?> =
    ...
    fun getPoints(): MutableList<Vector3?> {
        return points
    }

    companion object {
        private val TAG = LineSimplifier1::class.java.simpleName
