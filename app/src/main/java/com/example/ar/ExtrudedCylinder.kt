...
object ExtrudedCylinder {
    private val TAG = ExtrudedCylinder::class.java.simpleName
    ...
    private fun generateVerticesFromPoints(
        ...
        val bottomVertices: MutableList<Vertex> = ArrayList()
        ...
        for (edgeIndex in 0..NUMBER_OF_SIDES) {
            ...
            var normal = Vector3.subtract(topPosition, directionFromTopToBottom.scaled(-halfHeight))
                .normalized()
                    ...
                    .setUvCoordinate(
                        UvCoordinate(
                            ...
                            Vector3.subtract(
                                ...
                                .length()
                                    + vertices[previousSegmentVertexIndex].uvCoordinate!!.y
                        )
                    )
                    .build()
        ...
        for (edgeIndex in 0..NUMBER_OF_SIDES) {
            ...
            currentVertex.uvCoordinate = UvCoordinate(
                ...
                Vector3.subtract(
                    ...
                    .length()
                        + vertices[vertexIndex - NUMBER_OF_SIDES - 1].uvCoordinate!!.y
            )
        }
    }
    ...
    private fun makeDisk(
        ...
        for (edge in 0..NUMBER_OF_SIDES) {
            ...
            val theta = (2 * Math.PI * edge / NUMBER_OF_SIDES).toFloat()
